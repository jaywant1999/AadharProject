...
const AdminHelp = ()=> {
  return (
    ...
    <div className='guide-div'>
        ...
        <p>Use the statistics tab to view various statistics related to the elections. You can view statistics using different charts and graphs to visualize the data.</p>
    </div>
    <div className='guide-div'>
        <h3>View Profile</h3>
